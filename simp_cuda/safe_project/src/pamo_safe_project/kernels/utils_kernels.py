...
from .spd_project_native import spd_project_blocks
...
def block_spd_project_kernel(
    ...
    # Stock warp-lang has no wp.spd_project_blocks; local func_native extension.
    spd_project_blocks(3, block, it_max)
